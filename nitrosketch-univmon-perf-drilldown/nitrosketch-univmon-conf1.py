...
JHASH_HASH_FILE = f"{sys.path[0]}/../src/hash_lib/libjhash.so"
XXHASH32_HASH_FILE = f"{sys.path[0]}/../src/hash_lib/libxxhash32.so"
...
if __name__ == '__main__':
    ...
    b = BPF(src_file=f'{sys.path[0]}/../src/ebpf/ns_um/perf-drilldown/nitrosketch_univmon_main_conf1.h', cflags=custom_cflags,
            device=None)
